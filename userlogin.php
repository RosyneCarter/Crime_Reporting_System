...
<html lang="en">
	<head>
		...
		<title>ONLINE CRIME REPORTING SYSTEM | User Login</title>
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><a href="users/../index.html" style="color:#fff">ONLINE CRIME REPORTING SYSTEM</a></h3>
			<hr/>
    ...
    <script>
        $.backstretch("users/assets/img/security.jpg", {speed: 500});
    </script>
