...
else
{
  if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,state,fadd,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$fadd','$complaintdetials','$compfile')");
  ...
  <head>
    ...
    <title>ONLINE CRIME REPORTING SYSTEM | User Register Complaint</title>
    <!-- Bootstrap core CSS -->
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <form class="form-horizontal style-form" method="post" name="complaint" enctype="multipart/form-data" >
              ...
              <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">Facts Address</label>
                <div class="col-sm-4">
                  <input type="text" name="fadd" required="required" value="" required="" class="form-control">
                </div>
              </div>
              <div class="form-group">
