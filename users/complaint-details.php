...
<html lang="en">
  <head>
    ...
    <title>Oline Crime Reporting System | Complaint Details</title>
        ...
        <section class="wrapper site-min-height">
          ...
          {?>
            ...
            <div class="row mt">
              ...
              <div class="col-sm-4">
                <p><?php echo htmlentities($row['fadd']);?></p>
              </div>
            </div> 
            <div class="row mt">
              ...
              <label class="col-sm-2 col-sm-2 control-label"><b>Officer in Charge</label>
              <div class="col-sm-4">
