								...
								<tbody>
									...
									?>									
										...
										<tr>
											...
											<td ><b>Facts Address</b></td>
											<td colspan="3"> <?php echo htmlentities($row['fadd']);?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="5"><?php if($row['fullname']=="")
											{ echo "Choose officer";
											} else {
										...
										?>
											...
											<tr>
												...
												<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/CRS/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
												<button type="button" class="btn btn-primary">Take Action</button></td>
												</a><?php } ?></td>
												<td colspan="4">
												<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/CRS/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
