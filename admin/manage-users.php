					...
					<div class="content">
						<div class="module">
							<div class="module-head">
								<h3>Manage Users</h3>
								<a href="add_officer.php" onClick="" title="Add officer">
								<button type="button" class="btn btn-primary" align="left">Add Officer</button></a>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									?>									
										<tr>
											...
											<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/CRS/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
